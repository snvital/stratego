...
Game.prototype.move = function(moveString) {  
  ...
  switch (validMove.type) {
    ...
    if(this.board[validMove.captureSquare][1] === 'F'){
      ...
      if((validMove.pieceCode[1] === 'S'  && (this.board[validMove.captureSquare][1] != 'T' && this.board[validMove.captureSquare][1] != 'S')  )){
      ...
      //if guess
      else if(validMove.pieceCode[1] === '1' &&  (this.board[validMove.captureSquare][1] != 'B' ) &&  this.board[validMove.captureSquare][1] != 'F'){
